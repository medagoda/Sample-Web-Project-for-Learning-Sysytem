...
const Pricing = () => {
    ...
    const packages = [
        {name: "Start", monthlyPrice: 19, yearlyPrice: 199, description: "Basic features to get you going.", green: "/src/assets/circle.png"},
        {name: "Advance", monthlyPrice: 39, yearlyPrice: 399, description: "More options and features for further progress.", green: "/src/assets/circle.png"},
        {name: "Premium", monthlyPrice: 59, yearlyPrice: 599, description: "The ultimate package, providing advanced features.", green: "/src/assets/circle.png"}
    ]
    ...
    return (
        <div className="md:px-14 p-4 max-w-s mx-auto py-10" id="pricing">
            <div className="text-center">
                   ...
                   <p className="text text-tertiary md:w-1/3 mx-auto px-4">all available options or choices are presented, providing clarity and transparency regarding available offerings.</p>
